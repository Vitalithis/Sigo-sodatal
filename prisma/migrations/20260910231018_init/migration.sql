...
CREATE TABLE `Usuario` (
    ...
    `rol` ENUM('ADMIN', 'OFICINA', 'REPARTIDOR', 'PENDIENTE') NOT NULL DEFAULT 'PENDIENTE',
    ...
    UNIQUE INDEX `Usuario_user_id_key`(`user_id`),
...
-- CreateTable
CREATE TABLE `RutaBaseSector` (
    `id` VARCHAR(191) NOT NULL,
    `ruta_base_id` VARCHAR(191) NOT NULL,
    `sector_id` VARCHAR(191) NOT NULL,

    UNIQUE INDEX `RutaBaseSector_ruta_base_id_sector_id_key`(`ruta_base_id`, `sector_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Comuna` (
    ...
    UNIQUE INDEX `Comuna_nombre_key`(`nombre`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Sector` (
    `id` VARCHAR(191) NOT NULL,
    `nombre` VARCHAR(191) NOT NULL,
    `comuna_id` VARCHAR(191) NOT NULL,
    `activo` BOOLEAN NOT NULL DEFAULT true,

    UNIQUE INDEX `Sector_nombre_comuna_id_key`(`nombre`, `comuna_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `Usuario` ADD CONSTRAINT `Usuario_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `user`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Cliente` ADD CONSTRAINT `Cliente_sector_id_fkey` FOREIGN KEY (`sector_id`) REFERENCES `Sector`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `RutaBaseSector` ADD CONSTRAINT `RutaBaseSector_ruta_base_id_fkey` FOREIGN KEY (`ruta_base_id`) REFERENCES `RutaBase`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `RutaBaseSector` ADD CONSTRAINT `RutaBaseSector_sector_id_fkey` FOREIGN KEY (`sector_id`) REFERENCES `Sector`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Sector` ADD CONSTRAINT `Sector_comuna_id_fkey` FOREIGN KEY (`comuna_id`) REFERENCES `Comuna`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
